...
<div class="bg-gradient-to-r from-green-500/80 to-teal-500/80 shadow-sm border-t border-gray-200 mt-6 mb-6 rounded-xl" x-data="{ showIcons: false }">
    <div class="flex flex-col lg:flex-row items-center justify-between px-3 py-2 gap-4">
        ...
        <div class="w-full lg:w-auto" :class="showIcons ? 'block' : 'hidden lg:block'">
            <div
                class="bg-gray-50/20 lg:bg-transparent p-4 rounded-lg shadow lg:shadow-none grid grid-cols-3 sm:grid-cols-6 gap-4 text-xl justify-items-center">
                <a href="#" class="p-2 hover:bg-orange-100 rounded-full" title="Delivery">
                    <img src="https://chef.ordersplus.com.au/img/express-delivery.png" alt="Delivery" class="h-12 w-12" />
                </a>
                ...
                <a href="#" class="p-2 hover:bg-orange-100 rounded-full" title="Cart">
                    <img src="https://chef.ordersplus.com.au/img/logo_icons/cart_icon.png" alt="Cart" class="h-12 w-12" />
                </a>
            </div>
        </div>
    </div>
