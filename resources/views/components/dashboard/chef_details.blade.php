...
<div class="relative flex justify-between items-center bg-white rounded-2xl p-5 mb-6 shadow-2xl">
    ...
    <div class="absolute top-[-8px] right-0 bg-red-500 rounded-xl p-3 text-center w-20 shadow-md">
